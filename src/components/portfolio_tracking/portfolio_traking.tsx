...
const PortfolioTracking = () => {
  return (
    <div className="text-white  flex justify-center flex-col items-center mt-[100px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        {card.map(({ logo, name, text }, index) => (
          <div  key={index} className="p-6 rounded-lg shadow-md text-center w-[344px] border border-pink-500">
            <p className="text-font_section_header text-left font-bold mb-2">{index + 1}</p>
            <img src={`./img/portfolio/${logo}`} alt={logo} className="mx-auto mb-4" />
